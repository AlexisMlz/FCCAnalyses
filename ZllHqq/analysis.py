...
outputDirEos = "/eos/user/a/almaloiz/thesis/fcc/root/IDEA_newtagger/ZllHqq/"
eosType = "eosuser"
...
class RDFanalysis:
    ...
    def analysers(df):
        ...
        df2 = (
            ...
            # find Z leptons (only best Z->ll candidate: same flavour, opposite sign, mass closest to mZ)
            .Define(
        ...
        df3 = (
            df2.Define("event_d23", "JetClusteringUtils::get_exclusive_dmerge(_jet, 2)")
